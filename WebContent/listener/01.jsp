...
<body>
	...
	<p>
		...
		예를 들어, 요청이 발생할때 마다 할일, 어플리케이션이 종료될때해야될일 이 있다면,
		이벤트리스너를 통해서 설정이 가능하다.
	</p>
	<p>
		총 8개(application 2/ session 4/request 2)의 이벤트리스너가 만들어져있지만, 
		활용한 가능한 리스너는 6개(application 2/ session 2 / request 2) 이다.
		(나머지2개는 현재 버전대에서는 작동을 하지 않음.)
	</p>
</body>
</html>